...
**TKTK: Describe 2016-tiny-desk-voting-stl here.**
...
```
cd 2016-tiny-desk-voting-stl
mkvirtualenv 2016-tiny-desk-voting-stl
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1sqDzUI5bxZjQBOf5zl06fZRV4GXs4QzfA29o0jOEiBY#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1sqDzUI5bxZjQBOf5zl06fZRV4GXs4QzfA29o0jOEiBY', file_path)
    data = Copy(file_path)
...
```
workon 2016-tiny-desk-voting-stl
fab render
```
...
```
* * * * * ubuntu bash /home/ubuntu/apps/2016_tiny_desk_voting_stl/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|2016-tiny-desk-voting-stl|tweet|`location`||
|2016-tiny-desk-voting-stl|facebook|`location`||
|2016-tiny-desk-voting-stl|email|`location`||
|2016-tiny-desk-voting-stl|new-comment||
|2016-tiny-desk-voting-stl|open-share-discuss||
|2016-tiny-desk-voting-stl|close-share-discuss||
|2016-tiny-desk-voting-stl|summary-copied||
|2016-tiny-desk-voting-stl|featured-tweet-action|`action`|
|2016-tiny-desk-voting-stl|featured-facebook-action|`action`|
