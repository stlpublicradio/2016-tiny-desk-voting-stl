...
PROJECT_SLUG = '2016-tiny-desk-voting-stl'

# Project name to be used in file paths
PROJECT_FILENAME = '2016_tiny_desk_voting_stl'

# The name of the repository containing the source
REPOSITORY_NAME = '2016-tiny-desk-voting-stl'
...
ASSETS_SLUG = '2016-tiny-desk-voting-stl'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1sqDzUI5bxZjQBOf5zl06fZRV4GXs4QzfA29o0jOEiBY'
